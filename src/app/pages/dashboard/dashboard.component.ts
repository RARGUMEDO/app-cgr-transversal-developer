...
export class DashboardComponent {
  ...
  itemvalores : itemvalor[] = [{
    item_id: 1,
    itempadre_id: 0,
    itempadre_codigo: '01',
    itempadre_nombredetalle: 'Computación',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 2,
    itempadre_id: 1,
    itempadre_codigo: '02',
    itempadre_nombredetalle: 'Zona Gamer',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 3,
    itempadre_id: 1,
    itempadre_codigo: '03',
    itempadre_nombredetalle: 'Impresoras y Multifuncionales',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 4,
    itempadre_id: 2,
    itempadre_codigo: '04',
    itempadre_nombredetalle: 'Laptops',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 5,
    itempadre_id: 2,
    itempadre_codigo: '05',
    itempadre_nombredetalle: 'Monitores',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 6,
    itempadre_id: 0,
    itempadre_codigo: '06',
    itempadre_nombredetalle: 'Consolas y Videojuegos',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 7,
    itempadre_id: 6,
    itempadre_codigo: '07',
    itempadre_nombredetalle: 'Play Station',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 8,
    itempadre_id: 6,
    itempadre_codigo: '08',
    itempadre_nombredetalle: 'Nintendo',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 9,
  ...
  },
  {
    ...
    itempadre_id: 0,
    itempadre_codigo: '01',
    itempadre_nombredetalle: 'Celulares y Tablets',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 11,
    itempadre_id: 0,
    itempadre_codigo: '01',
    itempadre_nombredetalle: 'TV, Audio y Foto',
    itempadre_estado: 'Vigente',
  },
  {
    item_id: 12,
    itempadre_id: 0,
    itempadre_codigo: '01',
    itempadre_nombredetalle: 'Electro hogar',
    itempadre_estado: 'Vigente',
  }
];
...
interface itemvalor {
  item_id: number;
  itempadre_id: number;
  itempadre_codigo: string;
  itempadre_nombredetalle: string;
  itempadre_estado: string;
}
